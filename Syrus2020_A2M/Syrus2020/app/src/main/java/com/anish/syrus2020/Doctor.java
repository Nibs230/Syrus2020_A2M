...
public class Doctor {
    ...
    private String id,name,image,descp,rating,number_of_rating;

    public Doctor() {
    }

    public Doctor(String id, String name, String image, String descp,String rating,String number_of_rating) {
        this.id = id;
        this.name = name;
        this.image = image;
        this.descp = descp;
