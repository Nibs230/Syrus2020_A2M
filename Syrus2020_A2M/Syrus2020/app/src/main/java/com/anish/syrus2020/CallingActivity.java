        ...
        usersRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.child(receiverUserId).exists()
                        && dataSnapshot.child(receiverUserId).child("image")!=null
                        && dataSnapshot.child(receiverUserId).child("name")!=null) {
                    ...
                    Log.d("String tester",receiverUserName);
                    nameContact.setText(receiverUserName);
                    Picasso.with(getApplicationContext()).load(receiverUserImage).placeholder(R.drawable.profile_image).into(profileImage);
