...
public class ContactsActivity extends AppCompatActivity {
    ...
    protected void onStart() {
        ...
        Query contactref = contactsRef.child(currentUserId);
        ...
        FirebaseRecyclerAdapter<Contacts, ContactsViewHolder> firebaseRecyclerAdapter
            ...
            @Override
            protected void populateViewHolder(final ContactsViewHolder holder, Contacts contacts, int i) {
                ...
                usersRef.child(listUserId).addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        if(dataSnapshot.exists())
                        {
                            ...
                            Picasso.with(getApplicationContext()).load(profileImage).into(holder.profileImageView);
                        }
