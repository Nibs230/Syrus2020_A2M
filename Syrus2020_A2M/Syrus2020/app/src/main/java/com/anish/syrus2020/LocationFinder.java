...
public class LocationFinder extends AppCompatActivity implements LocationListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDatabse = FirebaseDatabase.getInstance().getReference().child("Drivers");
...
//                loggs4.setText(""+blist);
                ...
                for (DataSnapshot childSnapshot: dataSnapshot.getChildren()) {
                    ...
                    {
                        userName=childSnapshot.getRef().getParent().getKey().toString();
//
...
//                        startActivity(intent);
                ...
                //loggs3.setText(""+userName);
                //Log.d("problem valla part",""+userName);
                mUserCh= FirebaseDatabase.getInstance().getReference().child("Users").child(""+userName);
                mUserCh.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        if( dataSnapshot.getValue()!=null)
                        {
                            ...
                            //Log.d("problemabc",""+newPost.get("name"));
                            tv_officer_contact.setText(""+userName);
                        }
