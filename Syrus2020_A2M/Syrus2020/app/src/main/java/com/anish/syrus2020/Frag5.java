...
public class Frag5 extends Fragment {
    ...
    private void search(String str)
    {
        ...
        {
            if(object.getDescp().toLowerCase().contains(str.toLowerCase()))
            {
                myList.add(object);
            }
        }
    ...
    public class AdapterClass extends RecyclerView.Adapter<AdapterClass.MyViewHolder> {
        ...
        public void onBindViewHolder(@NonNull AdapterClass.MyViewHolder myViewHolder, final int i) {
            ...
            Picasso.with(getContext()).load(abc).into(myViewHolder.profile_img);
            ...
            myViewHolder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent intent = new Intent(getContext(),DoctorViewProfileActivity.class);
