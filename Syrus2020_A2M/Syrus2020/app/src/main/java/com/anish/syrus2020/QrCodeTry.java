...
public class QrCodeTry extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        med = FirebaseDatabase.getInstance().getReference().child("Medicine");
        ...
        if(result!=null && result.getContents()!=null)
        {
            med.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                      String medicc = dataSnapshot.child(result.getContents()).getValue().toString();
