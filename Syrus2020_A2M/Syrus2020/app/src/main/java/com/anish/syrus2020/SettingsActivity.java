...
public class SettingsActivity extends AppCompatActivity {
    ...
    private StorageReference userProfileImagRef;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userProfileImagRef = FirebaseStorage.getInstance().getReference().child("Profile Images");
    ...
    private void saveUserData() {
        ...
        if (ImageUri == null) {
            ...
            final StorageReference filePath = userProfileImagRef.child(FirebaseAuth.getInstance().getCurrentUser().getUid());
                ...
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        if(dataSnapshot.exists())
                        {
                            ...
                            Picasso.with(getApplicationContext()).load(imageDb).placeholder(R.drawable.profile_image).into(profileImageView);
